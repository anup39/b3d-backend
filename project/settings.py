...
CELERY_TASK_ROUTES = {
    ...
    'app.tasks.process_all_geodata_': {'queue': 'default'},
...
MAX_UPLOAD_SIZE = 1024 * 1024 * 1024 * 5  # 5 GB in bytes

DATA_UPLOAD_MAX_NUMBER_FIELDS = 8000
DATA_UPLOAD_MAX_MEMORY_SIZE = 10485760000  # 100 MB
